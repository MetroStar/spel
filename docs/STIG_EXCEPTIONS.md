...
This document describes STIG (Security Technical Implementation Guide) controls that are intentionally not implemented, require compensating controls, or must be configured post-deployment for SPEL hardened AMIs.
...
These controls are marked "Not Applicable" because SPEL AMIs are server builds without a graphical interface.
...
|------|---------|--------|---------|
| 2026-02-02 | 1.0 | SPEL Team | Initial documentation |

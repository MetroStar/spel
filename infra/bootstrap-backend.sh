...
#
# Options:
#   --prefix PREFIX     Resource name prefix (default: granite-offline)
...
# Defaults
PREFIX="${INFRA_PREFIX:-granite-offline}"
...
if aws dynamodb describe-table --table-name "$TABLE" --region "$REGION" &>/dev/null; then
  ...
  aws dynamodb create-table \
    ...
    --region "$REGION" \
    --tags Key=Project,Value=GRANITE Key=ManagedBy,Value=opentofu-bootstrap >/dev/null

...
ROLES_DIR="$REPO_ROOT/crucible/ansible/roles"
COLLECTIONS_DIR="$REPO_ROOT/crucible/ansible/collections"
...
BOOT_FIPS_WRAPPER="$REPO_ROOT/crucible/scripts/boot-fips-wrapper.sh"

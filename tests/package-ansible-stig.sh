...
ROLES_DIR="$REPO_ROOT/chimera/ansible/roles"
COLLECTIONS_DIR="$REPO_ROOT/chimera/ansible/collections"
...
BOOT_FIPS_WRAPPER="$REPO_ROOT/chimera/scripts/boot-fips-wrapper.sh"

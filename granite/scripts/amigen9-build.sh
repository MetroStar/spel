...
##############################################################################
PROGNAME="$(basename "$0")"
AMIGENBOOTSIZE="${GRANITE_AMIGENBOOTDEVSZ:-768}"
AMIGENBOOTLABL="${GRANITE_AMIGENBOOTDEVLBL:-boot_disk}"
AMIGENBRANCH="${GRANITE_AMIGENBRANCH:-main}"
...
AMIGENMANFSTAL2023="${GRANITE_AMIGENMANFSTAL2023}"
...
AMIGENSOURCE="${GRANITE_AMIGEN9SOURCE:-file://$(dirname $(dirname $(dirname $(readlink -f "$0"))))/vendor/amigen9}"
AMIGENSSMAGENT="${GRANITE_AMIGENSSMAGENT}"
AMIGENSTORLAY="${GRANITE_AMIGENSTORLAY}"
AMIGENTIMEZONE="${GRANITE_TIMEZONE:-UTC}"
AMIGENUEFISIZE="${GRANITE_AMIGENUEFIDEVSZ:-128}"
AMIGENUEFILABL="${GRANITE_AMIGENUEFIDEVLBL:-UEFI_DISK}"

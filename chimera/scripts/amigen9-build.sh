...
##############################################################################
PROGNAME="$(basename "$0")"
AMIGENBOOTSIZE="${CHIMERA_AMIGENBOOTDEVSZ:-768}"
AMIGENBOOTLABL="${CHIMERA_AMIGENBOOTDEVLBL:-boot_disk}"
AMIGENBRANCH="${CHIMERA_AMIGENBRANCH:-main}"
...
AMIGENMANFSTAL2023="${CHIMERA_AMIGENMANFSTAL2023}"
...
AMIGENSOURCE="${CHIMERA_AMIGEN9SOURCE:-file://$(dirname $(dirname $(dirname $(readlink -f "$0"))))/vendor/amigen9}"
AMIGENSSMAGENT="${CHIMERA_AMIGENSSMAGENT}"
AMIGENSTORLAY="${CHIMERA_AMIGENSTORLAY}"
AMIGENTIMEZONE="${CHIMERA_TIMEZONE:-UTC}"
AMIGENUEFISIZE="${CHIMERA_AMIGENUEFIDEVSZ:-128}"
AMIGENUEFILABL="${CHIMERA_AMIGENUEFIDEVLBL:-UEFI_DISK}"

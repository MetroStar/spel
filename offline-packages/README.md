...
```hcl
export PKR_VAR_crucible_cfnbootstrap_source="file://$(pwd)/offline-packages/aws-cfn-bootstrap-py3-latest.tar.gz"
export PKR_VAR_crucible_awscli_source="file://$(pwd)/offline-packages/awscli-exe-linux-x86_64.zip"
export PKR_VAR_crucible_ssm_agent_source="file://$(pwd)/offline-packages/amazon-ssm-agent.rpm"
```

...
build {
  ...
  provisioner "powershell" {
    ...
    inline = [
      "# CRITICAL: Temporarily disable Windows Firewall to ensure WinRM output flows back to Packer",
      "# STIG enables strict outbound filtering with deny rules that block WinRM responses",
      "# Firewall will be re-enabled by sysprep/first-boot or can be re-enabled at end of script",

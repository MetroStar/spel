...
build {
  ...
  provisioner "powershell" {
    ...
    inline = [
      ...
      "Start-Sleep -Seconds 1",
      "",
      "# ----- STEP 4: Copy our SetupComplete.cmd over EC2Launch's version -----",
      "Write-Host 'Step 4: Installing SPEL SetupComplete.cmd...'",
      "Start-Sleep -Milliseconds 500",
      ...
      "Write-Host 'SetupComplete.cmd installed.'",
      "Start-Sleep -Milliseconds 500",
      "Write-Host 'Contents of SetupComplete.cmd:'",
      "Start-Sleep -Milliseconds 250",
      "Get-Content 'C:\\Windows\\Setup\\Scripts\\SetupComplete.cmd' | ForEach-Object { Write-Host \"  $_\" }",
      "Start-Sleep -Seconds 1",
      "",
  ...
  provisioner "powershell" {
    ...
    inline = [
      ...
      "Start-Sleep -Seconds 1",
      "",
      "# ----- STEP 4: Copy our SetupComplete.cmd to target location -----",
      "Write-Host 'Step 4: Installing SPEL SetupComplete.cmd...'",
      "Start-Sleep -Milliseconds 500",
      "New-Item -Path 'C:\\Windows\\Setup\\Scripts' -ItemType Directory -Force | Out-Null",
      "Copy-Item -Path 'C:\\Windows\\Temp\\SetupComplete.cmd' -Destination 'C:\\Windows\\Setup\\Scripts\\SetupComplete.cmd' -Force",

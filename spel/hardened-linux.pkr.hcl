...
build {
  ...
  provisioner "shell" {
    ...
    inline = [
      ...
      "ls -la /usr/lib/python3.6/site-packages/ | grep -E '(seobject|semanage|sepolicy)'",
      "cp -rv /usr/lib/python3.6/site-packages/seobject.py /usr/local/lib64/python3.9/site-packages/",
      "cp -rv /usr/lib/python3.6/site-packages/semanage.py /usr/local/lib64/python3.9/site-packages/",
      "cp -rv /usr/lib/python3.6/site-packages/sepolicy /usr/local/lib64/python3.9/site-packages/",
      "echo 'Verifying copied modules...'",
      "ls -la /usr/local/lib64/python3.9/site-packages/ | grep -E '(seobject|semanage|sepolicy)'",

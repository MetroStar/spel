...
build {
  ...
  provisioner "shell" {
    ...
    inline = [
      ...
      "cp -r /usr/lib/python3.6/site-packages/seobject.py /usr/local/lib64/python3.9/site-packages/ 2>/dev/null || true",
      "cp -r /usr/lib/python3.6/site-packages/semanage.py /usr/local/lib64/python3.9/site-packages/ 2>/dev/null || true",
      "cp -r /usr/lib/python3.6/site-packages/sepolicy /usr/local/lib64/python3.9/site-packages/ 2>/dev/null || true",
